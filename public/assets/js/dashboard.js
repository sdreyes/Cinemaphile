...
$(function() {
    ...
    function renderMovies(data) {
        ...
        $("#search-results").append("<div id='addNewMovie' class='portBox'><form id='addNewMovie_form' name='addNewMovie' method='post' action='/addMovie'><label for='title_newMovie'>Title</label><input class='text' id='title_newMovie' name='title_newMovie' type='text' /><label for='year_newMovie'>Year</label><input name='year_newMovie' id='year_newMovie' type='text' />      <label for='genre_newMovie'>genre</label><input name='genre_newMovie' id='genre_newMovie' type='text' />      <label for='image_newMovie'>image</label><input name='image_newMovie' id='image_newMovie' type='text' /><button class='btn' id='addMovie-btn'>Add</button></form></div>");
    }
});